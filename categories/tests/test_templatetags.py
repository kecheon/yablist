...
class CategoryTagsTest(TestCase):
    ...
    def testBasicUsage(self):
        ...
        """
        # display_path_as_ul
        rock_resp = '<ul><li><a href="/ko/categories/">Top</a></li></ul>'
        ...
        expected_resp = '<ul><li><a href="/ko/categories/">Top</a><ul><li><a href="/ko/categories/world/">World</a><ul><li><strong>Worldbeat</strong><ul><li><a href="/ko/categories/world/worldbeat/afrobeat/">Afrobeat</a></li></ul></li></ul></li></ul></li></ul>'
        ...
        # breadcrumbs
        expected_resp = '<a href="/ko/categories/">' + u'업종분류'\
            + '</a>' ' &gt; ' '<a href="/ko/categories/world/">World</a> &gt; Worldbeat'
        resp = self.render_template(
            '{% load category_tags %}'
